...
data ADSL(keep = USUBJID SITEID); set ADAM.ADAM_DM_ADSL; run; *SITEID가 누락되어 결합;
...
%let a = STUDYID USUBJID PARAMCD PARAM AVISIT ADT AVAL BASE CHG SAFFL;
